...
<script type="text/javascript">
   ...
   <div class="start" style="background: url('${pageContext.request.contextPath}/resources/img/mate/friends.png');width: 100vw;height: 100vh;background-size: cover;">
        <div class="text-center d-flex flex-column justify-content-center align-items-center" style="font-family: 'Gothic A1', sans-serif;background: rgba(0,0,0,0.38);width: 100vw;height: 100vh;">
            <p style="color: rgb(237,255,223);font-size: 3rem;">올리브의 밥친구</p>
