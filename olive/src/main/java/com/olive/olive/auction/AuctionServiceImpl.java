...
public class AuctionServiceImpl implements AuctionService{
	...
	@Override
	public void deleteAuction(int num, String userId) throws Exception {
		try {
	...
	@Override
	public boolean isAuctionLikeUser(Map<String, Object> map) {
		boolean result = false;
		try {
			int cnt = dao.selectOne("auction.auctionLikeUserCount", map);
			if(cnt > 0) {
				result=true;
			}
		} catch (Exception e) {
	...
	@Override
	public int auctionLikeDelete(Map<String, Object> map) throws Exception {
		int result = 0;
		try {
			result=dao.deleteData("auction.auctionLikeDelete", map);
		} catch (Exception e) {
			e.printStackTrace();
			throw e;
		}
	...
	public List<Reply> listReplyAnswer(int answer) {
		...
		try {
			list = dao.selectOne("auction.listReplyAnswer", answer);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return list;
